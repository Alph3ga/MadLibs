...
# downloading/updating the NLTK databases
download('punkt')
...
def get_tokenized():  #gets a random story from the file and tokenizes it
    global token_story
...
def showMadLib():  # this is the function to show the final madlib window
    global window
    window = MadLibWindow()
...
def play_now():  # this is the function to show the window to enter the madlib choices
...
def get_choices(str_tokens):  # get the valid choices of words to be replaced as (POS_TAG, index)
